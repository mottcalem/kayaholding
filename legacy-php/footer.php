    <div class="brand-section">
        <div class="brand-track">
            <span>KAYA HOTELS</span><span>KAYA İNŞAAT</span><span>KAYA AIR</span><span>KAYA ENERJİ</span><span>KAYA SU</span><span>KAYA RESIDENCE</span>
            <span>KAYA HOTELS</span><span>KAYA İNŞAAT</span><span>KAYA AIR</span><span>KAYA ENERJİ</span><span>KAYA SU</span><span>KAYA RESIDENCE</span>
        </div>
    </div>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-logo">
                    ...
                    <p style="color: #666; font-size: 15px; line-height: 1.6; padding-right: 20px;">Türkiye'nin geleceğine yatırım yapan kurumsal ve vizyoner güç. Yarım asırlık köklü geçmişimizle sürdürülebilir büyüme adımları atıyoruz.</p>
                </div>
            ...
            <div style="margin-top: 60px; border-top: 1px solid var(--border); padding-top: 25px; display: flex; justify-content: space-between; align-items: center; color: #999; font-size: 11px;">
                <div style="display: flex; gap: 15px;">
                    <p>&copy; 2026 Kaya Holding. Tüm Hakları Saklıdır.</p>
                    <a href="statik.php" style="color: #999; text-decoration: underline;">Gizlilik Politikası</a>
                </div>
                <div class="footer-social">
                    ...
                    <a href="#" aria-label="Facebook"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg></a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        // Mobile Dropdown Menü Aç/Kapat Mantığı
        ...
        // Video Yüklenme & Akış Yönetimi (Faydalı Geçiş Efekti)
